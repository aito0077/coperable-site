...
angular.module('fronteraApp', [
    ...
    'fronteraApp.services',
    'fronteraApp.iniciativa',
    'fronteraApp.user',
    'fronteraApp.home',
    'fronteraApp.menu'
]).
config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    $routeProvider
    .when('/home', {
        templateUrl: '/static/sites/frontera/partials/home/home.html',
    ...
    .when('/info/enred', {
        templateUrl: '/static/sites/frontera/partials/static/red.html',
        controller: 'static-controller'
    })
    .when('/users/edit/:id', {
        templateUrl: '/static/sites/frontera/partials/user/edit.html',
        controller: 'user-edit'
    })
    .when('/users/:id', {
        templateUrl: '/static/sites/frontera/partials/user/profile.html',
